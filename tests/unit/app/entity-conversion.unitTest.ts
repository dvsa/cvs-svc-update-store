import {techRecordDocumentConverter} from "../../../src/app/tech-record-document-conversion";
import {convert} from "../../../src/app/entity-conversion";
import {DynamoDbImage} from "../../../src/infrastructure/dynamo/dynamodb-images";

jest.mock("../../../src/app/tech-record-document-conversion", () => {
    return {
