import {parseTestResults, TestResult, TestResults} from "../app/models/test-results";
import {TestType} from "../app/models/test-types";
import {
    CUSTOM_DEFECT_TABLE,
    DEFECTS_TABLE,
    FUEL_EMISSION_TABLE,
    ...
    VEHICLE_TABLE
} from "../app/table-details";
import {executePartialUpsert} from "../infrastructure/database/sql-execution";
import {TestResultUpsertResult} from "../app/models/upsert-results";
